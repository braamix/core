...
export function check() {
    ...
    // Three copies of a 6,183-byte file: more than the eight writes a pipe
    ...
    // The many-writes case: 18,549 bytes down a pipe the shell drains itself,
    // so without drain-before-wait this one hangs rather than fails. The
    // counts are three copies of /etc/help, so a line added there moves them.
    t.is("x=$(cat /home/c/big); echo \"$x\" | wc", "360 2796 18549");
