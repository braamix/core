...
export function check() {
    ...
    // Three copies of a 6,319-byte file: more than the eight writes a pipe
    ...
    // The many-writes case: 18,957 bytes down a pipe the shell drains itself,
    ...
    t.is("x=$(cat /home/c/big); echo \"$x\" | wc", "366 2853 18957");
