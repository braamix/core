...
export function check() {
    ...
    // Three copies of a 6,074-byte file: more than the eight writes a pipe
    ...
    // The many-writes case: 18,222 bytes down a pipe the shell drains itself,
    ...
    t.is("x=$(cat /home/c/big); echo \"$x\" | wc", "357 2748 18222");
