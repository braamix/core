...
export function check() {
    ...
    // Three copies of a 6,493-byte file: more than the eight writes a pipe
    ...
    // The many-writes case: 19,479 bytes down a pipe the shell drains itself,
    ...
    t.is("x=$(cat /home/c/big); echo \"$x\" | wc", "375 2928 19479");
